...
| **Full** | `/grim` or "din-bot mode" | Drop articles, filler, pleasantries, hedging. Fragments OK. Default. |
...
| **grim-compress** | `/grim-compress <file>` | Compress .md files to din-bot prose. Saves ~46% input tokens. |
| **grim-help** | `/grim-help` | This card. |
| **grim-stats** | `/grim-stats` | Token usage + savings for current session. |

See [grim-commit.md](grim-commit.md), [grim-review.md](grim-review.md), [grim-compress.md](grim-compress.md), [grim-stats.md](grim-stats.md), [din-bots.md](din-bots.md) for full rules.

## Deactivate

Say "stop grim", "stop din-bot", or "normal mode". Resume anytime with `/grim`, "smash word", or "din-bot mode".
