...
Write commit messages terse and exact. Conventional Commits format. No fluff. Why over what. Bots ship clean code.
...
- ✅
  ...
  Cuts LTE bandwidth on cold-launch screens. Bots move fast.
...
- ✅
  ...
  Old route returns 410. No mercy for stragglers.
  ```

Diff: bug fix, no body needed
- ✅ `fix(auth): token expiry use <= not <`
- Grim: "Bug found. Bug crushed. Bots win."
